				...
				<ul class="slides">
					<li ng-repeat="obj in $ctrl.collection">
						...
						<div class="caption center-align">
							<h3>{{obj.title}}</h3>
							<h5 class="light grey-text text-lighten-3">Episode: {{obj.episode_id}}</h5>
						</div>
					</li>
				</ul>
			</div>
		...
		asSlider.collection = [
			{
				"title": "A New Hope",
				"episode_id": 4,
				"img" : "http://4.bp.blogspot.com/--5Ob9bVoLXY/VUQw51hVloI/AAAAAAAAAUU/_OMaKF4GMKE/s1600/Ep4_OST.png",
			...
			},
			{
				...
				"episode_id": 2,
				"img" : "http://img1.wikia.nocookie.net/__cb20130822173923/starwars/images/2/24/EPII_AotC_poster.png",
			...
			},
			{
				...
				"episode_id": 1,
				"img" : "http://gnula.nu/wp-content/uploads/2015/03/Star_Wars_Episode_I_The_Phantom_Menace_poster_usa.jpg",
			...
			},
			{
				...
				"episode_id": 3,
				"img": "http://movies.geourdu.co/wp-content/uploads/2015/03/Star-Wars-Episode-III-Revenge-of-the-Sith-2005.jpg",
			...
			},
			{
				...
				"episode_id": 6,
				"img" : "http://3.bp.blogspot.com/-i5PUzeYRmUU/U-6LbEFIDQI/AAAAAAAAFV4/tiZr8wNHWMM/s1600/star-wars-episodio-7.jpg",
			...
			},
			{
				...
				"episode_id": 5,
				"img" : "http://www.subeimagenes.com/img/star-wars-episodio-v-1586614.jpg",
			...
			},
			{
				...
				"episode_id": 7,
				"img" : "http://elcineriodico.com/wp-content/uploads/2015/10/Poster-Star-Wars.jpg" ,
